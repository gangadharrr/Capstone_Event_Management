        ...
        return (
          ...
          <React.Fragment key={data.eventId}>
            ...
            <div className="row">
              ...
              <div className='col-md-3'>
                <div className="form-group">
                  <Select id="modeOfEvent" options={AccessLevelOptions} placeholder='Access Level' onChange={onChangeAccessLevel} defaultValue={{ label: data.accessLevel, value:data.accessLevel}} required />
                  <span htmlFor="accessLevel" className="text-danger">{data.err_accessLevel}</span>
                </div><br />
                <div className="form-group">
