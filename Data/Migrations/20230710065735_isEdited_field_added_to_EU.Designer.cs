...
namespace Capstone_Event_Management.Migrations
{
    ...
    [Migration("20230710065735_isEdited_field_added_to_EU")]
    partial class isEdited_field_added_to_EU
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Capstone_Event_Management.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Capstone_Event_Management.Models.CollegeEvents", b =>
                {
                    ...
                    b.Property<DateTime>("EndDateTimeOfEvent")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("LastDayToRegister")
                        .HasColumnType("datetime2");

                    b.Property<string>("ModeOfEvent")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime>("StartDateTimeOfEvent")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Capstone_Event_Management.Models.EventUpdates", b =>
                {
            ...
            modelBuilder.Entity("Capstone_Event_Management.Models.Students", b =>
                {
                    b.Property<string>("Email")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Capstone_Event_Management.Models.ApplicationUser", null)
                        .WithMany()
